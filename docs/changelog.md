...
This ClearHire changelog is a high-level, honest record of the app's notable changes and the capabilities it ships today. It is intentionally brief and factual: it tracks what exists and broadly when, without precise day-level dates or invented version history. For how any single feature works, follow the links into the [feature pages](/features/resume-builder).
...
The following describe what is available in ClearHire today, grouped by area rather than exact dates.
...
- **Job posting** with requirements and salary ranges.
- **Applicant tracking**, **talent search**, **employee reviews**, and **employer-side verification** — see [for companies](/features/for-companies).
